...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        List<Map<String, Object>> posts = List.of(
                ...
                Map.of(
                        "id", 7,
                        "title", "테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중 글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중글작성 중테스트 글작성 중테스트 글작성 중",
                        "excerpt", "테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중테스트 글작성 중",
                        "thumbnail", "",
                        "category", "TEST",
